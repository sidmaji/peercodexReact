...
import { GRADE_LEVELS, SCHOOLS } from '../constants'
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 px-4 py-8">
            <div className="max-w-2xl mx-auto">
                <div className="text-center mb-8">
                    <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Tell us about yourself</h1>
                    <p className="text-lg text-gray-600 mb-2">Help us create your profile with some additional information</p>
                    <p className="text-sm text-gray-500">Your phone number and Discord will only be shared with students you choose to mentor or get mentored by</p>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="phoneNumber" className="block text-sm font-medium text-gray-700 mb-2">
                                Phone Number
                                <span className="text-xs text-gray-500 ml-1">(optional - will be shared with accepted connections)</span>
                            </label>
                            <input
                                type="tel"
                                id="phoneNumber"
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className={`w-full px-3 py-2 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500 ${errors.emailConfirm ? 'border-red-500' : 'border-gray-300'}`}
                ...
                <div className="text-center mt-6">
                    <p className="text-sm text-gray-500">📱 Your contact information helps facilitate better mentoring connections</p>
                </div>
            </div>
        </div>
    )
