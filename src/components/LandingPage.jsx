      ...
      <div className="min-h-[60vh] flex items-center justify-center pt-8 pb-8">
        <div className="w-full text-center animate-fade-in">
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-500 mb-6 leading-relaxed px-2 max-w-3xl mx-auto">
            Whether you're struggling with AP Chemistry, need help with Calculus, or want to share your expertise in any subject, find your perfect mentor or mentee in our supportive academic community.
          </p>
        ...
        <div className="w-full py-10">
          ...
          <div className="mt-8 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl shadow-xl p-4 mx-2 lg:mx-6 xl:mx-10 2xl:mx-16 backdrop-blur-sm border border-white/20">
            <div className="grid md:grid-cols-3 gap-4 text-center">
              <div className="group">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">500+</div>
                <div className="text-base lg:text-lg text-gray-600">Students Connected</div>
              </div>
              <div className="group">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">150+</div>
                <div className="text-base lg:text-lg text-gray-600">Study Sessions</div>
              </div>
              <div className="group">
                <div className="text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1 group-hover:scale-110 transition-transform duration-300">50+</div>
