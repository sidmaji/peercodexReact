            ...
            <div className="max-w-3xl w-full bg-white rounded-xl shadow-lg p-0 relative animate-fade-in border-2 border-indigo-400 flex flex-col" style={{ maxHeight: '90vh' }}>
                ...
                <div className="overflow-y-auto p-8" style={{ maxHeight: 'calc(90vh - 56px)' }}>
                    ...
                    <p className="mb-4 text-gray-700">
                        PeerCodex is growing! We're looking for passionate individuals to help us expand mentor connections and promote our platform. If you enjoy building communities and supporting
                        student success, we want to hear from you.
                    </p>
                    ...
                    <ul className="list-disc pl-6 mb-4 text-gray-700">
                        <li>
                            <span className="font-semibold text-indigo-600">Paid Tutoring:</span> Tutors will be able to offer paid sessions and promote themselves for a small monthly fee.
                        </li>
                        <li>
                            <span className="font-semibold text-indigo-600">Mentor Leaderboard:</span> Recognize top mentors and celebrate their impact.
                        </li>
                        <li>
                            <span className="font-semibold text-indigo-600">More Than AP Subjects:</span> We're expanding to include a wider range of subjects and learning opportunities.
                        </li>
                    </ul>
