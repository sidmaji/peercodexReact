                            ...
                            {AP_SUBJECTS.map((subject) => (
                                <button
                                    ...
                                    className={`px-3 py-2 rounded-lg border-2 text-sm font-medium transition-all duration-200 ${
                                        criteria.subjects.includes(subject) ? 'border-indigo-500 bg-indigo-50 text-indigo-700' : 'border-gray-200 bg-white text-gray-700 hover:border-gray-300'
                                    }`}
                                >
                                    {subject}
                                </button>
                                        ...
                                        <div className="flex items-center gap-3 mb-2">
                                            ...
                                            <div>
                                                ...
                                                <div className="text-xs text-gray-500">
                                                    {mentor.school} &bull; {mentor.grade}
                                                </div>
                                            </div>
                                        </div>
